...
<html>
    ...
    <center>
        ...
        <div class="container a" style="background-image: url(../images/s1.jpg);">
                <h2><b>Proceed to checkOut by providing registration ID </b><small> <em><?php echo $_SESSION['username']; ?></em></small></h2>
        </div>
    <form method="post" action="../validation.php" class="container" style="background-image:url(../images/s7.jpg);">
        <div class="form-group container2">
            <label class="form-control">Reg ID:</label>
            <input name="reg_id" type="text" class="form-control" required>
          <button class="btn btn-success form-control" name="move_to_final_checkout" type="submit">CHECKOUT</button>
        </div> 
    </form>
